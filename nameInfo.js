async function getCountries() {
    try {
        ...
        let result = await fetch('https://api.nationalize.io/?name=' + Name.value);
        let data = await result.json();
        // Return data
            
        let countryList = data.country;
...
function unAbbreviate(abbrv){
    if(abbrv in countryCodes){
        return countryCodes[abbrv];
    }
    else{
        return "N/A";
    }
